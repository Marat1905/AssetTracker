                                                        ...
                                                        <div key={log.id} className="bg-gray-50 dark:bg-slate-800/50 rounded-xl p-4 hover:shadow-md transition-shadow">
                                                            ...
                                                            {log.performedBy && (
                                                                <div className="mt-2 text-sm text-gray-600 dark:text-gray-300 flex items-center gap-1">
                                                                    <span className="font-medium">Выполнил:</span> {log.performedBy}
                                                                </div>
                                                            )}
                                ...
                                <div className="card overflow-hidden">
                                    <div className="w-full">
                                        <table className="w-full table-fixed border-collapse">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th className="text-left p-3 bg-gray-50 dark:bg-slate-800 font-semibold">Дата</th>
                                                    <th className="text-left p-3 bg-gray-50 dark:bg-slate-800 font-semibold">Тип работ</th>
                                                    <th className="text-left p-3 bg-gray-50 dark:bg-slate-800 font-semibold">Позиция</th>
                                                    <th className="text-left p-3 bg-gray-50 dark:bg-slate-800 font-semibold">Смазка / Подшипник</th>
                                                    <th className="text-left p-3 bg-gray-50 dark:bg-slate-800 font-semibold">Исполнитель</th>
                                                    <th className="text-left p-3 bg-gray-50 dark:bg-slate-800 font-semibold">Комментарий</th>
                                                    <th className="text-left p-3 bg-gray-50 dark:bg-slate-800 font-semibold">Действия</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                {maintenanceLogs.map(log => {
                                                    ...
                                                    return (
                                                        <tr key={log.id} className="border-b border-gray-100 dark:border-slate-700">
                                                            ...
                                                            <td className="p-3 align-top whitespace-normal break-words">
                                                                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-accent/10 text-accent-dark text-sm">
                                                                    {maintenanceTypeLabels[log.workType] || log.workType}
                                                                </span>
                                                            </td>
                                                            <td className="p-3 align-top whitespace-normal break-words">
                                                            ...
                                                            <td className="p-3 align-top whitespace-normal break-words">
                                                                {log.workType === 'Lubrication' && (
                                                                    <span className="text-sm break-words">{log.lubricantTypeName || '—'}</span>
                                                                )}
                                                                {log.workType === 'BearingReplacement' && (
                                                                    <div className="text-sm flex flex-wrap items-center gap-1 break-words">
                                                                        {log.oldBearing && log.newBearing && log.oldBearing.type === log.newBearing.type &&
                                                                            ...
                                                                            <>
                                                                                ...
                                                                                {log.oldBearing && log.newBearing && <ArrowRight size={14} className="inline mx-1 text-accent flex-shrink-0" />}
                                                                                {log.newBearing && (

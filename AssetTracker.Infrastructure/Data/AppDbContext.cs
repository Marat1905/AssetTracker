...
public class AppDbContext : DbContext
{
    ...
    public DbSet<Bearing> Bearings { get; set; } // новая таблица
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<MaintenanceLog>(entity =>
        {
            ...
            // Новые внешние ключи на подшипники
            entity.HasOne(e => e.OldBearing)
                  .WithMany(b => b.OldMaintenanceLogs)
                  .HasForeignKey(e => e.OldBearingId)
                  .OnDelete(DeleteBehavior.Restrict);

            entity.HasOne(e => e.NewBearing)
                  .WithMany(b => b.NewMaintenanceLogs)

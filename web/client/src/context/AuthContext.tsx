...
export type TestRole = 'User' | 'Electric' | 'Admin';
...
interface AuthContextType {
    ...
    isAdmin: boolean;
    /** Признак роли электрослужбы */
    isElectric: boolean;
    /** Админ или электрослужба */
    isAdminOrElectric: boolean;

    /** Текущая тестовая роль ('User' | 'Electric' | 'Admin') */
    testRole: TestRole;
    /** Установить роль явно */
    setTestRole: (role: TestRole) => void;
    /** Переключить роль по кругу: User → Electric → Admin → User */
    cycleTestRole: () => void;
...
const ROLE_CYCLE: TestRole[] = ['User', 'Electric', 'Admin'];
